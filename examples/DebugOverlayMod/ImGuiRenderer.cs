...
namespace DebugOverlayMod
{
    ...
    public class ImGuiRenderer
    {
        ...
        public virtual unsafe void RebuildFontAtlas()
        {
            ...
            // HiDPI: scale default font up so it's readable on Retina displays
        ...
        protected virtual void UpdateInput()
        {
            ...
            // FNA reports mouse in backbuffer space already
            ...
            io.AddMouseWheelEvent(
                0, // FNA doesn't support HorizontalScrollWheelValue
